...
public interface MembershipRepository extends JpaRepository<MembershipEntity, Long>, MembershipRepositoryCustom {
     ...
     */
    default List<MembershipEntity> searchByExample(String name,
                                                   String email,
                                                   String address,
                                                   Boolean isCorp,
                                                   Boolean isValid) {
        ...
        MembershipEntity probe = builder.build();
        ...
        Example<MembershipEntity> example = Example.of(probe, matcher);
